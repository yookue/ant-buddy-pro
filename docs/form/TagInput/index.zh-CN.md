...
| 方法名              | 参数                                      | 描述       |
|------------------|-----------------------------------------|----------|
| getTagContents   | 无                                       | 获取标签内容列表 |
| setTagContents   | contents?: (string \| number)[] \| null | 设置标签内容列表 |
| addTagContent    | content?: string \| number \| null      | 添加单个标签内容 |
| removeTagContent | content?: string \| number \| null      | 移除单个标签内容 |
