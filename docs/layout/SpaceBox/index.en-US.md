...
Similar to [Space](https://ant.design/components/space) of [Ant Design](https://ant.design), `SpaceBox` provides padding spaces.
The difference is that, the `Space` provides spaces between more than one component, the `SpaceBox` wraps it's child/children component(s), even there is a single child.
...
|----------------|----------------------------------------------|-----------------------|-------------------|
| clazzPrefix    | The CSS class prefix of the component        | `string`              | `'abp-space-box'` |
...
| boundPadding   | Whether to pad the bound or not              | `boolean`             | `true`            |
