...
| delimiter          | The delimiter between the label and the content            | `React.ReactNode`                                         | `':'`                        |
| delimiterInLayout  | The layouts when should display the delimiter              | `'horizontal' \| 'vertical'[] \| false`                   | `['horizontal', 'vertical']` |
